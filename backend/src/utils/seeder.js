...
const seed = async () => {
  ...
  const categories = await ServiceCategory.bulkCreate([
    ...
    { name: 'Gesseiro', description: 'Instalação e manutenção de ar condicionado', icon: 'ac_unit' },
  ...
  // Cria os usuários de teste (2 clientes e 2 profissionais)
  ...
  // Cria especialidades para os Profissionais
